...
function useMDXComponents(components) {
  ...
  return React.useMemo(() => {
    ...
    return __spreadValues(__spreadValues({}, contextComponents), components);
...
function MDXProvider({ components, children, disableParentContext }) {
  ...
  return React.createElement(MDXContext.Provider, { value: allComponents }, children);
}
...
export { MDXProvider as M, ReactDOM as R, React as a, jsxRuntime as j, react as r, useMDXComponents as u };
